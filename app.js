/* ============================================================================
   app.js  —  shared JavaScript for ALL pages of the OMERO GYM site.
   One file drives login, register, classes, book and workouts.
   The current page is detected from <body data-page="...">.
   ----------------------------------------------------------------------------
   NOTE: login state & bookings are saved in the browser (localStorage).
   For that to persist across pages, run the site through a local server
   (e.g. the "Live Server" extension in VS Code) rather than double-clicking.
   ============================================================================ */
(function () {
  "use strict";
  ...
  /* ------------------------ SAFE STORAGE ------------------------ */
  /* Uses localStorage when available, else an in-memory fallback. */
  var _mem = {};
  var store = {
  ...
  function initChrome() {
    ...
    // logout (any button with data-action="logout")
